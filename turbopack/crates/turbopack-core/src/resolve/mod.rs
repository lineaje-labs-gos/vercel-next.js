...
pub enum ModulePart {
    ...
    /// Represents a namespace object of a module exported as named export. `None` members means
    /// the whole namespace object.
    RenamedNamespace {
        export: RcStr,
        members: Option<Vec<RcStr>>,
    },
...
impl ModulePart {
    ...
    pub fn renamed_namespace_members(export: RcStr, members: Vec<RcStr>) -> Self {
        ModulePart::RenamedNamespace {
            export,
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ModulePart::RenamedNamespace {
                ...
                write!(f, "export * as {export} members ")?;
