...
use crate::{
    ...
    analyzer::{
        ...
        cjs_ast::{
            as_module_exports_object_literal, is_exports_object, is_global,
            object_literal_sets_es_module, static_prop_names,
        },
...
impl<'a> Analyzer<'a, '_> {
    ...
    fn recognize_cjs_object_exports(
        ...
        // `__esModule: true` is the interop marker, not a droppable export: set the
        // flag and never drop it (below).
        if object_literal_sets_es_module(obj) {
            self.set_cjs_has_es_module();
        }
