...
Source the setup script, then build as usual:
...
It must be **sourced**, not executed — it exports environment variables into your shell, which a
subprocess cannot do. Running it directly prints an error and does nothing.
