...
export async function createHotReloaderTurbopack(
  ...
  const hotReloader: NextJsHotReloaderInterface = {
    ...
    getServerComponentsHmrRefreshHash() {
      // A value of 0 means no server component change has occurred yet,
      // matching webpack's undefined-until-first-change behavior.
      return hmrHash === 0 ? undefined : String(hmrHash)
    },
