...
- `context.routing`: Object containing Next.js routing phases and metadata
  - `routing.version`: Version of the routing contract. Version `2` keeps dynamic Pages API routes in the canonical `/api` namespace. Manifests without a version use the legacy version `1` semantics.
